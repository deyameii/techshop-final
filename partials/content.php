<section class="bg-gray-900 text-white">
  <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-[500px] lg:items-center">
    <div class="mx-auto max-w-3xl text-center">
      <h1
        class="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-extrapolated text-transparent sm:text-5xl">
      ...
      <div class="mt-8 flex flex-wrap justify-center gap-4">
        <a
          ...
          href="../catalog.php">Каталог товара</a>
        <a
